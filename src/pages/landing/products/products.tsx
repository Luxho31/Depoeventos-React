...
export default function Products() {
        ...
        getAllProducts()
            .then((data) => {
                ...
                const filtered = data.filter((product: Product) => {
                    const startDateInscription = new Date(
                        product.startDateInscription
                    );
                    const endDateInscription = new Date(
                        product.endDateInscription
                    );
                    return (
    ...
    const resetFilter = () => {
        ...
        const campusSelect = document.getElementById(
            "campusSelect"
        ) as HTMLSelectElement | null;
