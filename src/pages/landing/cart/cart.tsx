    ...
    return (
        <div className="flex flex-col w-[80%] m-auto mt-24">
            ...
            <div className={`${progressPercent === 100 ? "block" : "hidden"} flex items-start gap-12 mx-auto mb-24`}>
                ...
                {products.length != 0 ? (<div className="flex flex-col justify-around gap-y-8 mb-24">
                    <div className="bg-[#f3f3f9] h-fit w-[30rem] flex flex-col justify-between rounded-3xl shadow-md p-8">
                        ...
                        <div className="my-8 flex flex-col gap-2">
                            <div className="flex justify-between">
                                ...
                                <h2 className="text-lg text-slate-400 line-through">S/. {getTotalPrice()}.00</h2>
                            </div>
                            <div className="flex justify-between">
                            ...
                            <div className="flex justify-between">
                                ...
                                <h2 className="text-xl font-semibold">S/. {getTotalPrice()}.00</h2>
                            </div>
                        </div>
