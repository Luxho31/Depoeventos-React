    ...
    <div className="h-screen">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex justify-between items-center mb-5">
          <Button
            onClick={openCreateChildrenModal}
            className="flex items-center gap-x-2 max-sm:bg-blue-400"
          >
            <HiMiniPlus className="text-lg max-sm:bg-blue-400" />
            <p className="max-sm:hidden">Crear Hijo</p>
          </Button>
          <ChildrenModal
            type="create"
            id={undefined}
              ...
              <tr key={index} className="bg-white border-b hover:bg-gray-50">
                ...
                <td className="flex px-6 py-4 gap-x-2">
                  <button
                    ...
                    onClick={() => openEditChildrenModal(user.id)}
                  >
                  ...
                  <Popconfirm
                    ...
                    onConfirm={() => handleRemoveChildren(user.id)}
                    okText="Si"
                    cancelText="No"
                    okButtonProps={{
