      ...
      >
        <div className="flex gap-x-4 max-sm:flex-col">
          ...
          <Form.Item
            ...
            label="Dias"
            labelCol={{ span: 24 }}
            rules={[{ required: true, message: "Dias es requerido." }]}
            className="w-full"
          >
            <Select
          ...
          <Form.Item
            ...
            labelCol={{ span: 24 }}
            rules={[
              { required: true, message: "Hora de inicio es requerido." },
            ]}
            className="w-full"
          >
          ...
          <Form.Item
            ...
            label="Hora de fin"
            labelCol={{ span: 24 }}
            rules={[{ required: true, message: "Hora de fin es requerido." }]}
            className="w-full"
          >
            <Select placeholder="Selecciona la hora de fin" allowClear>
              {generateOptions()}
            </Select>
          </Form.Item>
        </div>
